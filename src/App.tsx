...
export default function App() {
  ...
  const [theme, setTheme] = useState<'dark' | 'light'>(() => {
    try {
      const saved = localStorage.getItem('alih_theme');
  ...
  // Sync theme with document.documentElement class list and attribute
  useEffect(() => {
    try {
      localStorage.setItem('alih_theme', theme);
    } catch (e) {
  ...
  return (
    <div className="min-h-screen bg-bg-app text-text-app flex flex-col justify-between selection:bg-text-app selection:text-bg-app transition-colors duration-300">
